 ...
 */
 routes.get("/:DIR1/:DIR2/:FILENAME/:ORIGNALNAME?",async (req,res,next)=>{
    try{
 ...
 */
routes.put("/:ID/hidden",async(req,res,next)=>{
    try{
 ...
 */
routes.delete("/:ID/hidden",async(req,res,next)=>{
    try{
 ...
 */
routes.put("/:ID/tags",async(req,res,next)=>{
    try{
